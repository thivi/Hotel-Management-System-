<%@ Page Language="C#" AutoEventWireup="true" CodeFile="registerusers.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="registerusers" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder1">
    ...
    <div class="validate">
        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="This field cannot be empty!" ForeColor="Red" ControlToValidate="TextBox6"></asp:RequiredFieldValidator>
    </div>
    ...
    <div class="validate">
        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="This field cannot be empty!" ForeColor="Red" ControlToValidate="TextBox7"></asp:RequiredFieldValidator>
    </div>
